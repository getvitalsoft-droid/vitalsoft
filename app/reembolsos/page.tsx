      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="space-y-8 text-white/55 text-sm leading-relaxed font-light">
          ...
          <section>
            ...
            <p>Para solicitar un reembolso escríbenos a <a href="mailto:hola@vitalsoft.pro?subject=Solicitud de reembolso&body=Hola, quiero solicitar un reembolso.%0A%0AEmail de mi cuenta: %0AMotivo: %0A" target="_blank" rel="noopener noreferrer" className="text-accent">hola@vitalsoft.pro</a> indicando el motivo. Respondemos en 48–72h laborables.</p>
          </section>
          <section>
