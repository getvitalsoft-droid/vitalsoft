...
const PASOS = [
  {
    n: "01",
    titulo: "Compartes tu carpeta de Drive",
    desc: "Durante el onboarding nos compartes una carpeta de Google Drive exclusiva. Trabajaremos siempre desde ahí y ahí recibirás todos tus clips.",
    color: "text-accent",
  },
  {
    n: "02",
  ...
  },
  {
    ...
    desc: "Podcast, vídeo, entrevista o clase. Lo subes a tu carpeta de Drive. Sin formatos especiales, sin instrucciones complicadas.",
    color: "text-white/60",
  },
  {
    n: "04",
